<div class="modal fade" id="modal-create-qualities-element">
    <form action="{{ route('company.info.store') }}" method="post" class="modal-dialog" data-sync="no" data-info="reset" enctype="multipart/form-data">
        @csrf
