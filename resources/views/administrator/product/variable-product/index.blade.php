                    ...
                    <table class="table">
                        <td>
                            <div class="form-group d-flex align-items-center">
                                ...
                                <input type="text" name="measures" value="{{$vp->measures}}" placeholder="Medidas" class="form-control">
                            </div>
                        </td>
                        <td>
            ...
            <div class="table-responsive">
                <table class="table">
                    <td>
                        <div class="form-group d-flex align-items-center">
                            <span class="mr-2" style="color: red;">*</span>
                            <input type="text" name="measures" placeholder="Medidas" class="form-control">
                        </div>
                    </td>
                    <td>
